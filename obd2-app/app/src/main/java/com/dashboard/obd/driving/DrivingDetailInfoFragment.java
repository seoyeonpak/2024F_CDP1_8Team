...
public class DrivingDetailInfoFragment extends Fragment implements ViewPager.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            Log.e("DrivingDetailInfoFragment","onCreateView");
            return null;
        }
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e("DrivingDetailInfoFragment","onViewCreated");
        }
    }
    ...
    public void onPageSelected(int position) {
        try {
            ...
            Log.e("DrivingDetailInfoFragment","onPageSelected");
        }
    }
    ...
    public void onObdDataReceived(ObdData data) {
        try {
            ...
            Log.e("DrivingDetailInfoFragment","onObdDataReceived");
        }
    }
    ...
    public void onObdExtraDataReceived(float rpm, int vss) {
        try {
            ...
            Log.e("DrivingDetailInfoFragment","onObdExtraDataReceived");
        }
    }
    ...
    private ArrayList<PageFragment> createPageFragments() {
        try {
            ...
            Log.e("DrivingDetailInfoFragment","createPageFragment");
    ...
    class PagerAdapter extends FragmentPagerAdapter {
        ...
        public PageFragment getItem(int position) {
            try {
                ...
                Log.e("DrivingDetailInfoFragment","getItem");
                return null;
            }
        }
    ...
    public static class PageFragment extends Fragment {
        ...
        private void setupPage1(View view) {
            try {
                ...
                Log.e("DrivingDetailInfoFragment","setupPage1");
            }
        }
        ...
        private void setupPage2(View view) {
            try {
                ...
                mValues.put(INTAKE_AIR_TEMPERATURE, (ValueView) view.findViewById(R.id.value_21)); //들어오는 공기 온도
                mValues.put(AMBIENT_AIR_TEMPERATURE, (ValueView) view.findViewById(R.id.value_22)); //상온
                ...
                Log.e("DrivingDetailInfoFragment","setupPage2");
            }
        }
        ...
        private void setupPage3(View view) {
            try {
                ...
                Log.e("DrivingDetailInfoFragment","setupPage3");
            }
        }
        private void setupPage4(View view) {
            try {
                ...
                Log.e("DrivingDetailInfoFragment","setupPage4");
            }
        }
        ...
        private void onObdDataReceivedPage1(ObdData data) {
            ...
            try {
                ...
                if (data.isValid(KEY.SAE_ECT)) { //추가함
                    vv = mValues.get(COOLANT);
                ...
                Log.e("DrivingDetailInfoFragment", "onObdDataReceivedPage1");
            }
        }
        ...
        private void onObdDataReceivedPage2(ObdData data) {
            ...
            try {
                ...
                if (data.isValid(KEY.SAE_AAT)) {//추가함
                    vv = mValues.get(AMBIENT_AIR_TEMPERATURE);
                ...
                if (data.isValid(KEY.SAE_EOT)) { //추가함
                    int eot = data.getInteger(KEY.SAE_EOT);
                    vv = mValues.get(ENGINE_OIL_TEMPERATURE);
                ...
                Log.e("DrivingDetailInfoFragment", "onObdDataReceivedPage2");
            }
        }
        ...
        private void onObdDataReceivedPage3(ObdData data) {
            ...
            try {
                ...
                Log.e("DrivingDetailInfoFragment", "onObdDataReceivedPage3");
            }
        }
        ...
        private void onObdDataReceivedPage4(ObdData data) {
            ...
            try {
                ...
                if (data.isValid(KEY.SAE_CMV)) {
                    vv = mValues.get(CONTROL_MODULE_VOLTAGE);
                    vv.getValueView().setText(String.format("%.1f", data.getFloat(KEY.SAE_CMV).floatValue()));
                }
            } catch (Exception e) {
                Log.e("DrivingDetailInfoFragment", "onObdDataReceivedPage4");
            }
        }
        ...
        public void onObdExtraDataReceived(float rpm, int vss) {
            if (mValues != null) {
                switch (mPage) {
                    case 0: // Page 1: ACCEL_POS ~ MIL
                        onObdExtraDataReceivedPage1(rpm, vss);
                        break;
        ...
        private void onObdExtraDataReceivedPage1(float rpm, int vss) {
            try {
                ValueView vv = mValues.get(VSS);
                ...
                Log.e("DrivingDetailInfoFragment", "onObdExtraDataReceivedPage1");
            }
        }
    }
